              ...
              <li className="flex items-center text-gray-300">
                ...
                <div>
                  <div className="flex items-center">
                    <span className="bg-gradient-to-r from-green-400 to-green-600 text-white text-xs font-bold px-1.5 py-0.5 rounded-full mr-2">NEW</span>
                    <span className="text-sm">Accès à Casus Analyse</span>
                  </div>
                  <div className="text-xs text-gray-400 ml-0 mt-1">(Analysez vos liasses fiscales)</div>
                </div>
              </li>
              <li className="flex items-center text-gray-300">
                <CheckCircle2 className="w-5 h-5 text-green-400 mr-3" />
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {[
            ...
            >
              ...
              <p className="text-gray-300 mb-6 italic text-sm">"{testimonial.content}"</p>
              <div className="flex items-center">
                {testimonial.photo && (
                  <img
                    src={testimonial.photo}
                    alt={testimonial.name}
                    className="w-12 h-12 rounded-full object-cover mr-3 border-2 border-purple-500/30"
                  />
                )}
                <div>
